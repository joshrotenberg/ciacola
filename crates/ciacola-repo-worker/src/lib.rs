...
use db::AssignmentDb;
use git::{gh, git_output, git_predicate, github_repo, worktree_is_clean};
use migrations::{ASSIGNMENTS_TABLE, MIGRATIONS};
use repos::{Repos, WorktreeSnapshot};
...
mod tests {
    ...
    use super::*;
    use crate::assignment::{LegacyAssignment, sqlite_u64};
    use crate::git::{bare_repo, github_origin_matches, repo_storage_key};
